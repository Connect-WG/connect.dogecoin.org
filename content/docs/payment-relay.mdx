---
title: Payment Relay
description: Relay API endpoints, submissions, statuses, and error handling.
---
...
<include>./schema-reference.mdx#payment_submission</include>
...
<include>./schema-reference.mdx#payment_status_accepted</include>

**403 — Declined:**

<include>./schema-reference.mdx#payment_status_declined</include>
...
<include>./schema-reference.mdx#error_response</include>
...
<include>./schema-reference.mdx#status_query</include>
