...
description: Quick reference for DogeConnect JSON schemas, enums, and relay payloads.
---
...
See [Payment Envelope](/docs/payment-envelope#8-dp-string) for details.
...
<section id="payment_status_accepted">
...
<section id="payment_status_declined">
